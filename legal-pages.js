export const LEGAL_PAGES = {
  ...
  confidentialitate: {
    ...
    sections: [
      ...
      ['Raportările de costuri', 'Pentru apă și salubritate colectăm separat localitatea, perioada, suma și, dacă sunt completate, consumul, numărul de persoane și numele. Numele este opțional, rămâne numai în baza de date și nu apare în statistici. Publicăm suma doar ca interval, iar statisticile sunt agregate. Raportarea este ștearsă automat după 90 de zile.'],
      ['Securitate și prevenirea abuzurilor', 'Folosim sesiuni semnate, protecție CSRF, limitarea încercărilor de autentificare și identificatori pseudonimi pentru a împiedica voturile, reacțiile, comentariile ori sesizările repetate. Pentru unele formulare, adresa IP este transformată într-o amprentă criptografică zilnică; aplicația nu păstrează adresa IP în clar, iar amprentele temporare sunt eliminate după aproximativ o zi.'],
      ...
      ['Cât timp păstrăm datele', 'Raportările de costuri sunt șterse după 90 de zile, amprentele IP anti-abuz după aproximativ o zi, iar linkurile de resetare a parolei expiră după o oră. Celelalte date sunt păstrate cât timp contul sau serviciul este activ și ulterior numai cât este necesar pentru obligații legale, securitate, soluționarea sesizărilor ori apărarea drepturilor.'],
