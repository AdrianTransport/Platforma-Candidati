export const LEGAL_PAGES = {
  ...
  confidentialitate: {
    ...
    intro: 'Platforma separă datele publice ale candidatului de datele folosite pentru cont, securitate și soluționarea sesizărilor.',
    sections: [
      ['Date publice', 'Numele candidatului, funcția, zona, afilierea, informațiile de transparență și materialele publicate sunt afișate public la solicitarea candidatului.'],
      ['Date administrative', 'Datele de autentificare, contractare, acceptare și jurnalul de securitate sunt folosite pentru executarea serviciului, protejarea conturilor, respectarea obligațiilor legale și apărarea drepturilor.'],
      ['Sesizări', 'Numele și emailul persoanei care raportează sunt opționale. Dacă sunt furnizate, sunt folosite numai pentru analiza și soluționarea sesizării și nu sunt afișate public.'],
      ['Furnizori tehnici', 'Datele aplicației sunt găzduite prin infrastructura Netlify. Operatorul și candidatul stabilesc prin contract rolurile lor privind protecția datelor.'],
      ['Drepturi și contact', 'Solicitările privind accesul, corectarea, ștergerea sau opoziția pot fi trimise la adresa juridică afișată pe această pagină. Păstrarea datelor depinde de contract, obligațiile legale și necesitatea soluționării disputelor.'],
    ],
  },
  raportare: {
